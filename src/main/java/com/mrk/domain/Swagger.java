...
import com.mrk.domain.auth.SecuritySchemeDefinition;
...
public class Swagger {
    ...
    protected Map<String, ModelImpl> definitions;
    ...
    public Swagger parameter(String key, Object parameter) {
    ...
    public Swagger ModelImpl(String name, ModelImpl ModelImpl) {
        this.addDefinition(name, ModelImpl);
        return this;
    }
    ...
    public Map<String, ModelImpl> getDefinitions() {
        return definitions;
    }

    public void setDefinitions(Map<String, ModelImpl> definitions) {
        this.definitions = definitions;
    }

    public void addDefinition(String key, ModelImpl ModelImpl) {
        if (this.definitions == null) {
            this.definitions = new HashMap<String, ModelImpl>();
        }
        this.definitions.put(key, ModelImpl);
    }
